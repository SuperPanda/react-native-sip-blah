...
## About
* This repo is based on a fork of [florindumitru/react-native-sip](https://github.com/florindumitru/react-native-sip) which is based on a fork of [datso/react-native-pjsip](https://github.com/datso/react-native-pjsip).
* It also implements conference call features from [AssacNetworks/react-native-pjsip-assac](https://github.com/AssacNetworks/react-native-pjsip-assac) -- only implemented android changes so far.
